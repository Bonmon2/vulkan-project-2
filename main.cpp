...
#include "vecMathsLib/vecMaths.h"
...
private:
    ...
    void createGraphicsPipeline() {
        ...
        auto attibuteDescriptions = Vertex::getAttributeDescriptions();

        vertexInputInfo.vertexBindingDescriptionCount   = 1;
        vertexInputInfo.vertexAttributeDescriptionCount = static_cast< uint32_t > ( attibuteDescriptions.size() );
        vertexInputInfo.pVertexBindingDescriptions      = &bindingDesription;
        vertexInputInfo.pVertexAttributeDescriptions    = attibuteDescriptions.data();
    ...
    bool checkValidationLayerSupport() {
        ...
        for( const char* layerName : validationLayers ) {
            ...
            for( const auto& layerPorperties : availableLayers ) {
